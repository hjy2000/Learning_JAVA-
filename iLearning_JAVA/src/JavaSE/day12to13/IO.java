...
class File1 {
  public void test() {
    File f = new File("G:\\Java projects\\iLearning_JAVA\\src\\JavaSE\\day12to13\\t.txt");
    // 这里用/可以（unix写法） 或者\\转义也可以（win写法）
    File f1 = new File("src/JavaSE/day12to13", "ttt.txt");
    File f3 = new File("./");
    ...
    // projects\\iLearning_JAVA\\src\\JavaSE\\day12to13\\ttt.txt"));//重命名
    //        f1.renameTo(new File("src/JavaSE/day12to13/123.txt"));//相对路径 同级是项目根目录
  ...
  public void test2() {
    File f = new File("src/JavaSE/day12to13/ccc");
    File f1 = new File("src/JavaSE/day12to13/a/b/c");
    f.mkdir(); // 创建单层目录 目录多层就要执行多次
    f1.mkdirs(); // 创建多层目录
  }

  public void test3() {
    File f = new File("src/JavaSE/day12to13");
  ...
  public void test5() {
    ...
    try {
      FileInputStream f =
          new FileInputStream("G:\\Java projects\\iLearning_JAVA\\src\\JavaSE\\day12to13\\t.txt");
      byte[] b = new byte[100];
      int len = 0;
    ...
    try {
      ...
      FileOutputStream f =
          new FileOutputStream(
              "G:\\Java projects\\iLearning_JAVA\\src\\JavaSE\\day12to13\\t123.txt", true);
  ...
  public void copy() {
    ...
    try {
      FileInputStream fin =
          new FileInputStream(
              "G:\\Java projects\\iLearning_JAVA\\src\\JavaSE\\day12to13\\t123.txt");
      FileOutputStream fout =
          new FileOutputStream(
              "G:\\Java projects\\iLearning_JAVA\\src\\JavaSE\\day12to13\\t123_copy.txt");
      byte[] b = new byte[50];
      int len;
...
public class IO {
  public static void main(String[] args) {
    String inPath1 = "G:\\Java projects\\iLearning_JAVA\\src\\JavaSE\\day12to13\\t.txt";
    String inPath = "G:\\Java projects\\iLearning_JAVA\\src\\JavaSE\\day12to13\\t123.txt";
    String outPath = "G:\\Java projects\\iLearning_JAVA\\src\\JavaSE\\day12to13\\t123_copy.txt";
    File1 ff = new File1();
    try {
      //        ff.test2();
      //        ff.test3();
