...
//        new test1().t2();
    ...
    public void t2()
    {
        ...
        System.out.println("abc"=="abc");//true 这里直接“abc”是true 因为这里的abc是直接存在字符串常量池中的 第一次创建好abc以后 第二次发现有abc存在直接把地址给过去了 所以==比较也是true
        ...
        //String s=new String("x")+new String("x")+new String("y"); 这样的话在常量池中创建x和y对象 然后在堆中创建xxy对象将地址赋给s（StringBuilder）
    }
}
